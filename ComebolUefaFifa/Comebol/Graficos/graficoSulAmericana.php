...
<head>
    ...
    <link rel="stylesheet" href="../../../css/cssComebol/graficoSulAmericana.css">
    <title>Grafico Títulos Sul Americana</title>
</head>
<body>
    <div class="styleTabela">
        ...
        function drawChart() {
            ...
            ["<?php echo $nomeClube ?>", <?php echo $titulosChampions ?>, "blue"], 
    ...
    <div class="divButtonStyle">
        <a href="../sulamericana.php" class="styleAbutton">
