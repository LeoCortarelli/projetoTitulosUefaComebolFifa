...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssComebol/sulamericana.css">
...
<body>
    <div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM sul_americana ORDER BY quant_titulos DESC";
        ...
        <div class="divButtonStyle">
            <a href="../../ComebolUefaFifa/Comebol/inicialComebol.html" class="styleAbutton">
                <button class="btn"><img src="../../img/incon_voltar_white.png" class="rounded" alt="" width="25px"><div class="espacamento"></div>VOLTAR</button>
            </a>   
            <a href="../Comebol/Graficos/graficoSulAmericana.php" class="styleAbutton">
