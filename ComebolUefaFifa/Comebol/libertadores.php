...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssComebol/libertadores.css">
...
<body>
    <div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM libertadores ORDER BY quant_titulos DESC";
        ...
        <div class="divButtonStyle">
            ...
            <a href="../Comebol/Graficos/graficoLibertadores.php" class="styleAbutton">
