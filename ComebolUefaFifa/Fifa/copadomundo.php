...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssFifa/copadomundo2.css">
...
<body>
    <div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM copa_mundo ORDER BY quant_titulos DESC";
