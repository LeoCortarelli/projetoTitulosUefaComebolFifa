...
<head>
    ...
    <link rel="stylesheet" href="../../../css/cssFifa/Grafico/graficoMundialClubes.css">
    <title>Grafico Copa do mundo</title>
</head>
<body>
    <div class="styleTabela">
        ...
        function drawChart() {
            ...
            var options = {
                title: "Grafico de titulos do mundial da copa do mundo",
                width: 1500,    
                height: 500,
                bar: {groupWidth: "95%"},
    ...
    <div class="divButtonStyle">
        <a href="../copadomundo.php" class="styleAbutton">
