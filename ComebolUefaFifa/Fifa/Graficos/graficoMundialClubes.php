...
<head>
    ...
    <title>Grafico Títulos Mundial</title>
</head>
<body>
    <div class="styleTabela">
        ...
        function drawChart() {
            ...
            <?php
                ...
                $sql = "SELECT * FROM mundial_clubes";
            ...
            var options = {
                title: "Grafico de titulos do mundial de clubes",
                width: 1500,    
                height: 500,
                bar: {groupWidth: "95%"},
    ...
    <div class="divButtonStyle">
        <a href="../mundialClubles.php" class="styleAbutton">
