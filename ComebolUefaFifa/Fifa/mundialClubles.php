...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssFifa/mundialclubes.css">
...
<body>
    <div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM mundial_clubes ORDER BY quant_titulos DESC";
