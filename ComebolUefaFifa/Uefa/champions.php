...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssUefa/styleChampions2.css">
...
<body>
    <div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM champions_league ORDER BY quant_titulos DESC";
        ...
        <div class="divButtonStyle">
            ...
            <a href="../Uefa/Graficos/graficoChampions.php" class="styleAbutton">
