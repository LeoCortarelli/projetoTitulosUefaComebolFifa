...
<head>
    ...
    <link rel="stylesheet" href="../../css/cssUefa/styleEuropa3.css">
...
<div>
        ...
        <?php
            $sqlMaioresVencedores = "SELECT * FROM europa_league ORDER BY quant_titulos DESC";
        ...
        <div class="divButtonStyle">
            ...
            <a href="../Uefa/Graficos/graficoEuropaLeague.php" class="styleAbutton">
